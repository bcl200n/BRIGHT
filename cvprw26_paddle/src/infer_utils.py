"""Shared helper utilities for inference-style commands (PaddlePaddle version)."""
...
def resolve_data_dirs(data_cfg: dict) -> tuple:
...
def save_coco_results(coco_results: list, output_path: str) -> None:
