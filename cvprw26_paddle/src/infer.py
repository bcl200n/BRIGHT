"""Competition inference entry-point (PaddlePaddle version): generate a submission JSON from a checkpoint."""
...
def main():
    parser = argparse.ArgumentParser(description="Run Mask R-CNN inference and export a submission JSON/ZIP (PaddlePaddle)")
    ...
    parser.add_argument("--ann-file", default=None, help="COCO image manifest or annotation JSON used for inference")
    parser.add_argument("--output", default=None, help="Override output JSON/ZIP path from config")
    parser.add_argument("--num-workers", type=int, default=None, help="Override dataloader workers")
    parser.add_argument("--zip", "--gzip", dest="zip_output", action="store_true")
    parser.add_argument("--no-zip", "--no-gzip", dest="zip_output", action="store_false")
